...
export const BUSINESS_PILLARS: BusinessPillar[] = [
  {
    ...
    shortDescription:
      "Integrated high-performance network, software, and physical computing infrastructures designed for enterprise growth.",
    detailedDescription:
      "In today's digital landscape, modern organizations require robust, secure, and unified systems. Syntax Technology designs, deploys, and manages international-standard IT infrastructures that eliminate operational friction.",
    iconName: "Cpu",
    colorTheme: {
    ...
    services: [
      {
        ...
        description:
          "High-speed structured copper and fiber optic cabling, professional routing, switching, and robust WAN/LAN designs.",
        iconName: "Network",
        benefits: [
          "Zero network downtime",
          "Secure bandwidth partitioning",
          "Scalable for future offices",
        ],
      },
      {
        name: "System Integration & Automation",
        description:
          "Unifying multi-vendor systems, hardware, cloud instances, and workflows into a single manageable ecosystem.",
        iconName: "Combine",
        benefits: [
          "Reduced administrative overhead",
          "Synchronized cross-departmental data",
      ...
      },
      {
        ...
        description:
          "Development, configuration, and implementation of business-specific management software and ERP extensions.",
        iconName: "Code2",
        benefits: [
          "Tailored work tools",
      ...
      },
      {
        ...
        description:
          "SLA-driven physical hardware cleaning, operating system updates, anti-virus protocols, and proactive optimization.",
        iconName: "Wrench",
        benefits: [
          "Extended hardware lifespan",
          "Pre-empt failures before they disrupt",
          "24/7 dedicated Helpdesk SLA",
        ],
      },
    ],
  },
  {
    ...
    shortDescription:
      "Comprehensive commercial surveillance, access control, and biometrics to safeguard assets and audit operations.",
    detailedDescription:
      "Physical security is the bedrock of business continuity. We deploy smart biometrics, IP camera surveillance, and fleet GPS solutions that provide ultimate control, absolute safety, and accurate operational metrics.",
    iconName: "Shield",
    colorTheme: {
    ...
    services: [
      {
        ...
        description:
          "Multi-megapixel IP camera arrays, network video recorders (NVR), night-vision infrared sensors, and remote secure mobile feeds.",
        iconName: "Camera",
        benefits: [
          "Complete blind-spot coverage",
          "High-fidelity incident footage",
      ...
      },
      {
        ...
        description:
          "Face recognition and fingerprint readers connected to magnetic locks, enabling exact electronic logs of employee movement.",
        iconName: "Fingerprint",
        benefits: [
          "Eliminated buddy punching",
          "Perfect automated payroll sync",
      ...
      },
      {
        ...
        description:
          "Real-time location, speed, fuel consumption monitoring, and geofencing limits for cars, bikes, and logistics vehicles.",
        iconName: "MapPin",
        benefits: [
          "Reduced unauthorized vehicle use",
          "Enhanced asset recovery security",
          "Lowered operational fuel costs",
        ],
      },
      {
        name: "Security System Integration",
        description:
          "Wiring fire alarms, motion detectors, smart biometrics, and security shutters into centralized, easily managed emergency panels.",
        iconName: "Layers",
        benefits: [
          "Instant automated alarm response",
          "Unified multi-hazard monitoring",
          "Audit trail of every single access event",
        ],
      },
    ],
  },
  {
    ...
    shortDescription:
      "Practical, industry-aligned technical skill development in digital security, automation, and core systems.",
    detailedDescription:
      "Technology is only as effective as the professionals operating it. Syntax Technology provides high-impact, short-term certification courses for students, working professionals, and corporate cohorts.",
    iconName: "BookOpen",
    colorTheme: {
    ...
    services: [
      {
        ...
        description:
          "Hands-on classes tailored to practical application, minimizing theoretical bloat to maximize functional skill capture.",
        iconName: "Timer",
        benefits: [
          "Completed in weeks, not years",
          "Flexible morning/evening classes",
          "Direct practical lab access",
        ],
      },
      {
        name: "Corporate Team Training",
        description:
          "On-site customized workshops upskilling operations staff in enterprise systems, cyber hygiene, and business automation.",
        iconName: "Users",
        benefits: [
          "Custom-curated for your software",
          "Increased internal troubleshooting capability",
          "Minimizes reliance on external IT calls",
        ],
      },
      {
        name: "Professional Digital Skills",
        description:
          "Advanced learning in digital collaboration tools, remote work software, office management, and networking systems.",
        iconName: "GraduationCap",
        benefits: [
          "Enhanced employee productivity",
          "Confidence with complex software",
          "CV booster with practical certification",
        ],
      },
    ],
  },
  {
    ...
    shortDescription:
      "Corporate branding, premium large-format printing, custom signage, and hardware advertising materials.",
    detailedDescription:
      "Beyond software and networks, brands must have a strong physical presence. Syntax Technology offers state-of-the-art print and marketing materials that align corporate identity with technology capabilities.",
    iconName: "Briefcase",
    colorTheme: {
    ...
    services: [
      {
        ...
        description:
          "High-resolution corporate collateral printing, including custom brochures, executive stationery, business cards, and catalogues.",
        iconName: "Printer",
        benefits: [
          "Vibrant, true-to-life color calibration",
          "Premium weight materials",
          "Professional-grade design layout",
        ],
      },
      {
        name: "Advertising & Signage",
        description:
          "Indoor acrylic branding, outdoor weatherproof LED lightboxes, pull-up banners, and high-visibility roadside signage systems.",
        iconName: "Megaphone",
        benefits: [
          "Eye-catching commercial presentation",
          "Durable materials for extreme weather",
          "End-to-end installation and wiring",
        ],
      },
      {
        name: "Business Technology Support",
        description:
          "Sourcing and procuring specialized printing, POS terminal setups, scanning machinery, and commercial barcode solutions.",
        iconName: "Laptop",
        benefits: [
          "Guaranteed vendor-authorized hardware",
          "Pre-configured and tested on-site",
          "Direct local warranty handling",
        ],
      },
    ],
  },
...
export const CUSTOMER_PROBLEMS: CustomerProblem[] = [
  {
    ...
    problem:
      "Critical facilities struggle with blind spots, unmonitored entries, and fragmented security architectures.",
    impact:
      "Creates vulnerabilities, inventory shrinkage, and lack of accountability during crucial security incidents.",
    solution:
      "Syntax installs multi-megapixel, remotely viewable IP surveillance and biometric systems integrated into one secure local network.",
  ...
  },
  {
    ...
    problem:
      "Manual attendance records, paper punch-cards, and spreadsheet-based tracking are prone to manipulation ('buddy punching') and manual entry errors.",
    impact:
      "Inflates payroll costs, wastes hours of HR time, and provides zero real-time insights into actual staff presence.",
    solution:
      "We deploy cloud-syncable biometric facial recognition and fingerprint access terminals that lock physical gates and feed directly to payroll engines.",
    pillarId: "security-smart",
  },
  {
    id: "prob-3",
    ...
    problem:
      "Internal networks frequently drop, internet configurations fail, and computers crash without a dedicated IT officer on staff.",
    impact:
      "Halts sales, disrupts communication, causes data loss, and leaves staff stranded with tech bottlenecks.",
    solution:
      "Syntax provides dedicated, SLA-driven monthly computer maintenance, remote helpdesk assistance, and emergency on-site technician response.",
  ...
  },
  {
    ...
    problem:
      "Using multiple disjointed software suites, outdated local hardware, and manual transfers that result in massive operational silos.",
    impact:
      "Slow customer delivery, high administrative error rates, and difficulty scaling up operations.",
    solution:
      "We execute customized system integrations and business automation routines that sync your hardware and software.",
    pillarId: "tech-solutions",
  },
  {
    id: "prob-5",
    ...
    problem:
      "University courses provide heavy theoretical concepts but lack practical, hands-on configuration experience with modern workplace tech.",
    impact:
      "Graduates are uncompetitive in the job market, and current professionals struggle when assigned to modern biometric or IT deployment projects.",
    solution:
      "Our Technical Training center provides direct lab access to actual CCTV cameras, network routers, and biometric setups with professional guidance.",
    pillarId: "training",
  },
  {
    id: "prob-6",
    ...
    problem:
      "Struggling with fragmented branding suppliers, low-quality printing, and generic signage that fails to present a premium image.",
    impact:
      "Diverts resources to multiple suppliers, resulting in inconsistent colors, delayed schedules, and diminished corporate credibility.",
    solution:
      "Syntax delivers end-to-end print, large-format sign, and hardware branding solutions, guaranteeing absolute consistency and visual premium.",
...
export const COURSES: Course[] = [
  {
    ...
    description:
      "A highly practical masterclass covering the planning, wiring, networking, and commissioning of commercial IP surveillance networks and biometric authentication terminals.",
    targetAudience: [
  ...
  },
  {
    ...
    description:
      "Learn how to build, secure, and maintain computer networks for modern businesses, following global industry standards.",
    targetAudience: [
    ...
    location:
      "Virtual Interactive Lab Classroom (Access to physical switches via remote tunneling)",
  ...
  },
  {
    ...
    description:
      "Designed for corporate cohorts looking to fully master modern business tech support, printer networks, scanning pipelines, and basic automation scripts.",
    targetAudience: [
...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    description:
      "Syntax designed and deployed a comprehensive biometric entry gate and multi-channel CCTV security system for a high-security administrative facility.",
    category: "Security & Intelligent Systems",
    industry: "Public Sector Administration",
    challenge:
      "A high-security administrative facility required restricted, auditable access across 8 external entry points and main distribution hubs to prevent tailgating and log unauthorized entries. Existing physical security lacked unified digital tracking, leading to manual paper guest books and severe visual monitoring bottlenecks.",
    solutionDetail:
      "Syntax designed and deployed a comprehensive biometric entry gate and multi-channel CCTV security system. This involved integrating Suprema biometric terminal readers with dual-lane active optical turnstiles, establishing a secure localized local area network (VLAN) for the security grid, and creating a dedicated master security monitor room.",
    ...
    outcome:
      "A fully digitized audit trail of all personnel movements. The facility successfully digitized 100% of employee entry/exit timestamps, eliminated unauthorized tailgating incidents entirely, and secured 8 external entry points with continuous, real-time video surveillance recorded securely.",
  },
  {
    id: "proj-2",
    ...
    description:
      "Overhauled a degraded, slow-speed cabling system for an enterprise office occupying 3 floors, moving them to unified structured Cat6 networks with redundant active backups.",
    category: "Enterprise IT Infrastructure",
    industry: "Private Enterprise / Corporate Office",
    challenge:
      "An enterprise office occupying 3 floors suffered from frequent network drops, localized IP conflicts, slow file transfer speeds capping at 10Mbps, and messy unlabelled network patch cables. The lack of standard rack management and network segregation led to daily operational downtime.",
    solutionDetail:
      "Syntax performed a full structured cabling overhaul. We removed legacy wiring, installed premium 42U server cabinets, laid 120 custom-terminated Cat6 runs, and deployed managed gigabit switches to segregate HR, accounts, and guest networks via VLANs. We secured their operations with an ongoing Monthly Preventive Support SLA.",
    scopeOfImplementation: [
    ...
    outcome:
      "Restored network speeds from 10Mbps to full Gigabit capability across all 3 floors, eliminating internet dropouts. Provided 100% operational uptime through our ongoing monthly computer maintenance contract and certified structured layouts.",
  },
  {
    id: "proj-3",
    ...
    description:
      "Created high-visibility brand presence for a busy commercial showroom. This project synchronized their physical advertising presence with corporate design aesthetics.",
    category: "Business Technology & Automation",
    industry: "Retail & Commercial Hub",
    challenge:
      "A busy commercial showroom required a prominent visual brand presence that could survive harsh weather conditions while keeping energy costs efficient. Their interior brand assets lacked consistency, undermining customer perception in a competitive retail district.",
    solutionDetail:
      "Syntax designed, fabricated, and installed custom exterior LED backlit lightboxes and interior premium laser-cut acrylic corporate signboards. The system uses high-efficiency Samsung LED modules paired with twilight sensors, alongside highly durable rustproof aluminum framing designed to survive Kigali's tropical rainy seasons.",
    scopeOfImplementation: [
    ...
    outcome:
      "Significantly increased walk-in visitor traffic by approximately 35% through enhanced brand visibility. Maintained consistent corporate color matching across all lightboxes and interior walls, with high-durability seals surviving severe weather conditions without water ingress.",
  },
];
