                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-50 dark:border-slate-800/50">
                      ...
                      <div className="flex gap-2 items-start text-xs">
                        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-wider shrink-0 w-20 mt-0.5">
                          {t("solutions.problem")}:
                        </span>
                      ...
                      <div className="flex gap-2 items-start text-xs bg-red-50/10 dark:bg-red-950/5 p-2 rounded-lg border border-red-500/10">
                        <span className="text-[9px] uppercase font-black text-red-600 dark:text-red-400 tracking-wider shrink-0 w-20 mt-0.5">
                          {t("solutions.impact")}:
                        </span>
                      ...
                      <div className="flex gap-2 items-start text-xs bg-emerald-50/10 dark:bg-emerald-950/5 p-2 rounded-lg border border-emerald-500/10">
                        <span className="text-[9px] uppercase font-black text-emerald-600 dark:text-emerald-400 tracking-wider shrink-0 w-20 mt-0.5">
          ...
          <section className="p-6 sm:p-10 rounded-3xl bg-slate-900 text-white relative overflow-hidden border border-slate-800">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-4 flex justify-center">
                <div
                  className={`p-8 rounded-full border border-slate-800/80 bg-slate-850/60 text-blue-400 animate-pulse`}
                >
                  {activeSolution &&
                    React.createElement(activeSolution.icon, { className: "w-20 h-20" })}
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="lg:col-span-5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 rounded-2xl p-6 sm:p-8 space-y-5">
              ...
              <div className="space-y-2.5">
                {activeSolution?.whoItIsFor.map((user, i) => (
                  <div
                    key={i}
                    className="flex gap-2.5 items-center p-3 bg-slate-50/50 dark:bg-slate-950/40 border border-slate-100/60 dark:border-slate-850/60 rounded-xl text-xs"
                  >
          ...
          <section className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 rounded-3xl p-6 sm:p-8 space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 max-w-2xl">
                We utilize a standardized 5-step engineering plan to ensure that hardware works
                flawlessly with no performance leaks.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative pt-4">
              {activeSolution?.implementationProcess.map((step, idx) => (
                <div
                  key={idx}
                  className="relative space-y-3 p-4 bg-slate-50 dark:bg-slate-950/45 border border-slate-100 dark:border-slate-850 rounded-2xl"
                >
                  {/* Step bubble */}
            ...
            <section className="space-y-6">
              ...
              <div className="max-w-3xl mx-auto">
                {PORTFOLIO_PROJECTS.filter((p) =>
                  activeSolution.relevantProjectIds.includes(p.id),
                ).map((project) => (
                  <div
                    key={project.id}
          ...
          <section className="p-8 sm:p-10 bg-slate-900 text-white rounded-3xl border border-slate-800 relative overflow-hidden text-center max-w-4xl mx-auto space-y-6">
            ...
            <div className="relative max-w-xl mx-auto space-y-3">
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Connect with our certified field engineers. We will inspect your premises, calculate
                node capacity, and draft a formal stamped proposal.
              </p>
            </div>
