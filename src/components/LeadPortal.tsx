...
import { RefreshCw, Search, ShieldCheck, ChevronDown, ChevronUp, MessageSquare, Clock, CheckCircle2, AlertTriangle, Eye, Edit3 } from "lucide-react";
...
export const LeadPortal: React.FC<LeadPortalProps> = ({ onTriggerRefresh }) => {
  const { t, formatLocalizedDate } = useLocalization();
                        ...
                        <div className="bg-white dark:bg-slate-950 p-3 rounded-lg border border-slate-100 dark:border-slate-800 space-y-1.5 text-xs">
                          ...
                          {lead.type === "quote" && (
                            <>
                              ...
                              {lead.data.quantity > 1 && <p><span className="text-slate-400 font-medium">Nodes/Workstations:</span> {lead.data.quantity}</p>}
