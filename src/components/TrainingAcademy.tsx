...
import { 
  BookOpen, Search, Award, Clock, Laptop, MapPin, Calendar, Users, 
  CheckCircle2, ArrowLeft, Building2, Sparkles, Shield, FileText, 
  ChevronRight, GraduationCap, TrendingUp, Send, Check, Briefcase, 
  Wifi, UserCheck, Cpu, AlertCircle, HelpCircle, ArrowRight, Loader2, Sparkle
} from "lucide-react";
...
export const TrainingAcademy: React.FC<TrainingAcademyProps> = ({
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setRegError(err.message || "Something went wrong registering for the training.");
    } finally {
  ...
  const handleCorporateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setCorpError(err.message || "Something went wrong registering corporate interest.");
    } finally {
