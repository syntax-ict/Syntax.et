...
interface AIAssistantProps {
  onAutoSelectForm?: (formType: "consultation" | "quote" | "training" | "support", initialData?: any) => void;
}

export const AIAssistant: React.FC<AIAssistantProps> = ({ onAutoSelectForm }) => {
  ...
  const handleSend = async (textToSend: string) => {
    ...
    try {
      ...
      setError(err.message || "Failed to communicate with Syntax AI. Please check server connections.");
